...
ROMAJI_INFO romaKeys[] = {
	...
	[MOJI_QUESTION] = {KEY_RIGHTSHIFT,KEY_SLASH,0}, /* MOJI_QUESTION 91 */
	[MOJI_SLASH] = {KEY_RIGHTSHIFT,KEY_APOSTROPHE,0}, /* MOJI_SLASH 92 */
	...
	[MOJI_LBRACKET] = {KEY_RIGHTSHIFT, KEY_RIGHTBRACE,0}, /* MOJI_LBRACKET 96 */
	[MOJI_RBRACKET] = {KEY_RIGHTSHIFT,KEY_BACKSLASH,0}, /* MOJI_RBRACKET 97 */
	[MOJI_LPAREN] = {KEY_RIGHTSHIFT,KEY_8,0}, /* MOJI_LPAREN 98 */
	[MOJI_RPAREN] = {KEY_RIGHTSHIFT,KEY_9,0}, /* MOJI_RPAREN 99 */
